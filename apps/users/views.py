...
from .serializers import UserSerializer, UserSignUpSerializer, UserSignInSerializer, UserPsswdSerializer
...
class userForgetPsswd(generics.CreateAPIView):
    queryset=User.objects.all()
    serializer_class= UserPsswdSerializer